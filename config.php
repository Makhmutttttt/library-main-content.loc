...
define('DB_NAME', 'demo_library'); // Replace with your MySQL database name
...
$conn = new mysqli('127.0.0.1', 'root', '', 'demo_library'); // Replace with your database connection details
